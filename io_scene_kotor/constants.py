...
JADE_NODE_DUMMY      = 0x0001
JADE_NODE_REFERENCE  = 0x0002
JADE_NODE_HAS_MESH   = 0x0020
JADE_NODE_TRIMESH    = 0x0021
JADE_NODE_SKIN       = 0x0061
JADE_NODE_AABB       = 0x0221
JADE_NODE_WTRAIL     = 0x0821
JADE_NODE_CLOTH      = 0x4021
